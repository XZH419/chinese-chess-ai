...
- **MCTS-Minimax** (`MCTSMinimaxAI` in `algorithm/mcts_minimax.py`): MCTS 全局探索 + 叶节点浅层 Minimax 战术精算
...
4. **MCTS-Minimax**: `MCTSMinimaxAI` — same `choose_move` / `get_best_move` API as other engines; CLI / benchmark key: `mcts_minimax`
