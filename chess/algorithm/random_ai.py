...
class RandomAI:
    ...
    def choose_move(self, board, time_limit: Optional[float] = None) -> Optional[Tuple[int, int, int, int]]:
    ...
    def get_best_move(self, board, time_limit: Optional[float] = None) -> Optional[Tuple[int, int, int, int]]:
